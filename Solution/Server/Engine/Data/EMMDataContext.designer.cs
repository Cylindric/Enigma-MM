...
namespace EnigmaMM.Engine.Data
{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="Schedules")]
    ...
    partial void OnSchedule_Type_IDChanging(int value);
    ...
    partial void OnLastRunTimeChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Schedule_Type_ID", DbType="Int NOT NULL")]
		public int Schedule_Type_ID
		{
			get
			{
				return this._Schedule_Type_ID;
			}
			set
			{
				if ((this._Schedule_Type_ID != value))
				{
					if (this._ScheduleType.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnSchedule_Type_IDChanging(value);
					this.SendPropertyChanging();
					this._Schedule_Type_ID = value;
					this.SendPropertyChanged("Schedule_Type_ID");
					this.OnSchedule_Type_IDChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_NextRunTime", DbType="DateTime")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_LastRunTime", DbType="DateTime")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ScheduleType_Schedule", Storage="_ScheduleType", ThisKey="Schedule_Type_ID", OtherKey="Schedule_Type_ID", IsForeignKey=true, DeleteOnNull=true)]
			...
			set
			{
							...
							|| (this._ScheduleType.HasLoadedOrAssignedValue == false)))
				{
					...
					if ((value != null))
					{
						...
						this._Schedule_Type_ID = value.Schedule_Type_ID;
					}
					else
					{
						this._Schedule_Type_ID = default(int);
					}
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="ScheduleTypes")]
    ...
    partial void OnCodeChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Schedule_Type_ID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int Schedule_Type_ID
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="ScheduleType_Schedule", Storage="_Schedules", ThisKey="Schedule_Type_ID", OtherKey="Schedule_Type_ID")]
